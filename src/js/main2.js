...
$(document).ready(function(){
    ...
    //Ação para visualizar todos os partidos.
    $("#link-all-deputados").click(openAllCongressmen);
});




function openAllCongressmen(){
    //Abre o modal
    $('#modal-list-deputados').modal('show');
    //Box do conteúdo do modal
    var $box = $("#content-list-deputados");
    //Esconde o box com o filtro
    $(".box-filter-all-deputados").hide();
    
    //Monta o alert de carregamento
    ...
    //Efetua a requisição de todos deputados
    var congressmen = [];
    function success(result){
        ...
        //Lista os deputados
        View.printListCongressmen($box,congressmen,function(){
            //Exibe o box com o filtro
    ...
    Request.getCongressmen(success,error);
 ...
 * @returns {undefined}
 */
function printListDeputados($box,deputados,callback){
 ...
 * @returns {undefined}
 */
function listSelectPartidos(callback){
